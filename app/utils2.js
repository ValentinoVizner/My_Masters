window.onload = function() {
    ...
    function start_(API, suffix) {
        ...
        //Add baselayer
        API.tileLayer('https://api.mapbox.com/styles/v1/vaba/cjj4kcfyn4e5d2smpi7jqnxj3/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoidmFiYSIsImEiOiJjaml0NGFsbTQwN2ZiM2tsbWpxbXhveHJuIn0.TDZy4uXjgDPt3_FM-gNDXA', {
